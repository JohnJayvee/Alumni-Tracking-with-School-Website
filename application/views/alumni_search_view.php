                ...
                <div class="outer">
                    <div class="inner bg-container">
                        ...
                        <?php } ?>
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Alumni Tracking Number</th>
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Firstname</th>
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Middle Name</th>
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Lastname</th>
                                                    ...
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Citizenship</th>
                              ...
                              <td><?=$value->alumni_tracking_no?></td>
                              ...
                              <td><?= date($value->date_registered);?></td>
