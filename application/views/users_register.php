            ...
            <div class="outer">
                <div class="inner bg-container forms">
                    ...
                    <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 input_field_sections">
                                            ...
                                            <input required  type="username" class="form-control" name="firstname" value=""/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 input_field_sections">
                                            ...
                                            <input required  type="username" class="form-control" name="lastname" value=""/>
                                        </div>
                                    </div>
                                    <div class="row">
										<div class="col-lg-4 input_field_sections">
                                            <h5>Username <span style="color: #cc0000">*</span></h5>
											<input required  type="username" class="form-control" name="username" value=""/>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4 input_field_sections">
                                            ...
                                            <select class="form-control" name="status" value="" required style="width:282px;">
                                    ...
                                    <div class="row">
										<div class="col-lg-4 input_field_sections">
                                            ...
                                            <select class="form-control" name="acct_type" value="" required style="width:282px;">
