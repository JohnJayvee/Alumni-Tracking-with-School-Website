                    ...
                    <div class="inner bg-container">
                        ...
                        <?php } ?>
                                ...
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="<?=base_url('attendance-register')?>" id="editable_table_new" class=" btn btn-default">
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Date Time Attend</th>
                                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Action</th>
							...
							<td><span><?=$value->firstname." ".$value->lastname ?></span></td>
                              <td><span><?=$value->event_title ?></span></td>
                                <td><span><?=$value->event_time ?></span></td>
                                <td><span><?=$value->date_time_attend ?></span></td>
                                <td><?php echo anchor('employee/delete_attendance?id='.$value->attend_id, 'DELETE', 'id="$value->attend_id"');?></td>
