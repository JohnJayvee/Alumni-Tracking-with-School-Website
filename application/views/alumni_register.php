                ...
                <div class="inner bg-container forms">
					...
					<?php } ?>
									<form action="" method="post">
                                        ...
                                        <div class="col-lg-4 input_field_sections" style="width:800px; margin:0 auto;">
                                            <h5>Your Alumni Tracking Number<span style="color: #cc0000">*</span></h5>
											<input required type="text" class="form-control" name="alumni_tracking_no" value="<?php $this->load->helper('rand_helper');$randomString=generateRandomString(3);echo $randomString;?>-<?php $this->load->helper('rand_helper');$randomString=generateRandomString(3);echo $randomString;?>-<?php $this->load->helper('rand_helper');$randomString=generateRandomString(3);echo $randomString;?>" readonly/>

                                        </div>
                                    <div class="row">
                                        <div class="col-lg-4 input_field_sections">
                                            <h5>First Name <span style="color: #cc0000">*</span></h5>
											                     <input required type="text" class="form-control" name="firstname" value="" onkeydown="isLetters(event)"/>
                                        </div>
                                        <div class="col-lg-4 input_field_sections">
                                            <h5>Middle Name <span style="color: #cc0000">*</span></h5>
											                     <input required type="text" class="form-control" name="middlename" value="" onkeydown="isLetters(event)"/>
                                        </div>
                                        <div class="col-lg-4 input_field_sections">
                                            <h5>Last Name <span style="color: #cc0000">*</span></h5>
											                     <input required type="text" class="form-control" name="lastname" value="" onkeydown="isLetters(event)"/>
                                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4 input_field_sections">
                             ...
                             <input required type="text" class="form-control" name="contact_number" value="" onkeypress="isNumber(event)" />
                          </div>
                          ...
                          <div class="col-lg-4 input_field_sections">
                             ...
                             <input required type="text" class="form-control" name="citizenship" value="" onkeydown="isLetters(event)"/>
                          </div>
...
//onkeydown="isLetters(event)"
 function isLetters(e){
