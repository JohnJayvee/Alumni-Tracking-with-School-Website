                ...
                <div class="inner bg-container forms">
                    ...
                    <div class="row">
                      <div class="col-lg-4 input_field_sections">
                         ...
                         <input required type="text" class="form-control" name="event_title" value=""/>
                      </div>
                  ...
                  <div class="row">
										<div class="col-lg-4 input_field_sections">
											...
											<div class="input-group bootstrap-timepicker timepicker">
												<input required="" type="text" class="form-control input-small timepicker1" name="event_time"  style="background:white" readonly>
                  ...
                  <div class="row">
                    <div class="col-lg-4 input_field_sections">
                        <h5>Event Venue<span style="color: #cc0000">*</span></h5>
                       <input required type="text" class="form-control" name="event_venue" value=""/>
                    </div>
                  </div>

                  <div class="row">
                    <div class="col-lg-4 input_field_sections">
                        <h5>Event Date <span style="color: #cc0000">*</span></h5>
                        <input required="" type="text" class="form-control datepicker" name="event_date" value="" style="background-color: white;" required readonly/>
                      </div>
                  </div>
